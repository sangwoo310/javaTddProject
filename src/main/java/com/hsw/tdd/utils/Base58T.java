...
public class Base58T {
    /**
     * Base58T Hashing utility class
     */
    ...
    private static void setAlphabet(String alphabet) {
    ...
    public static String encodeToString(byte[] input, String alphabet) {
    ...
    public static byte[] decodeToByte(String input, String alphabet) throws Exception {
        setAlphabet(alphabet);
        buildIndexes();
